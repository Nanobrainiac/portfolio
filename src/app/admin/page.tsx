...
function inputClass() {
  return "w-full rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm outline-none focus:border-emerald-400";
}
...
export default async function AdminPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8">
        <p className="text-sm font-medium text-emerald-300">Admin</p>
        <h1 className="mt-2 text-3xl font-semibold">Portfolio editor</h1>
        {missingSupabase ? (
